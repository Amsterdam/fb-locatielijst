# Generated by Django 5.0.1 on 2024-01-07 19:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(choices=[('BOOL', 'Boolean'), ('DATE', 'Datum'), ('EMAIL', 'E-mail'), ('INT', 'Numeriek'), ('MEMO', 'Memo'), ('POST', 'Postcode'), ('STR', 'Tekst'), ('URL', 'Url'), ('CHOICE', 'Keuzelijst')], max_length=10, verbose_name='Gegevens type')),
            ],
            options={
