...
class Location(models.Model):
    ...
    street_number_letter = models.CharField(max_length=10, null=True, blank=True)
    street_number_extension = models.CharField(
        verbose_name='Letter toevoeging', max_length=10, null=True, blank=True)
    postal_code = models.CharField(verbose_name='Postcode', max_length=7) # aparte validatie voor postcode
