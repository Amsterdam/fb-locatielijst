# Generated by Django 5.0.1 on 2024-01-10 11:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_name",
                    models.CharField(
                        max_length=10, validators=[locations.models.validate_short_name], verbose_name="Korte naam"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("pandcode", models.IntegerField(default=locations.models.compute_pandcode, verbose_name="Pandcode")),
                ("name", models.CharField(max_length=100, verbose_name="Naam")),
                ("last_modified", models.DateTimeField(auto_now=True, verbose_name="Laatste wijziging")),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name="location",
            constraint=models.UniqueConstraint(fields=("pandcode",), name="unique_pandcode"),
        ),
        migrations.AddConstraint(
            model_name="location",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="locations.location", verbose_name="Locatie"
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="locations.externalservice", verbose_name="Externe API"
            ),
        ),
        migrations.AddField(
            model_name="locationexternalservice",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    models.Q(("property_option__isnull", False), ("value__isnull", True)),
                    models.Q(("property_option__isnull", True), ("value__isnull", False)),
                    _connector="OR",
                ),
